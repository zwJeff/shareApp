...
public class ShareRecordListAdapter extends BaseAdapter {
    ...
    public ShareRecordListAdapter(List<ResourceRespModel> resourceList,  Context context) {
    ...
    private void fillValue(int position, ViewHolder viewHolder) {
            ...
            viewHolder.resource_uploadtime.setText("上传于" + FormatUtil.DateFormat(resourceList.get(position).getResourceUploadTime()));
    ...
    public void addDataList(List<ResourceRespModel> dataList){
        this.resourceList.addAll(dataList);
